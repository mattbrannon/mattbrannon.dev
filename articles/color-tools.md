...
The `Color` class accepts several different types of input. You can use any valid css color as a
...
You can use also use the `Color` utility to generate an array of colors using the `shades`, `tints`,
