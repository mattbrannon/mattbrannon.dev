...
//     setValue(n);
//     const id = setTimeout(() => create(min, max), n * 1000);
//     return id;
//   },
//   cancel() {
//     clearTimeout(id);
//   },
// };
// let setMin = (min) => (max) => randomNumber(min, max);

// const useRandom = (minTimeout, maxTimeout) => {
//   const initialState = randomNumber(minTimeout, maxTimeout);
...
//   useEffect(() => {
//     const setMax = setMin(minTimeout);

//     const repeat = () => {
//       const randomTimeout = setMax(maxTimeout);
