    ...
    <>
      ...
      <div>
        ...
        <p>
          ...
          programmer. When you're first starting out, the idea of building a chat app
      ...
      <div>
        ...
        <p>
          ...
          pretty cool components in this app. I'm especially proud of the floating label
          text input. Also, you can't really tell from the app but, the social media
          signin buttons are completely scalable. The button logo and any text scales
      ...
      <div>
        ...
        <p>
          ...
          authentication methods for user sign up and login functionality. Users are able
          to login with their Google or Facebook accounts as well as the standard email /
